(s=>{function _(t){this.name="DjangoJsError",this.message=t||""}(_.prototype=new Error).constructor=_
...
throw new _('URL for view "'+t+'" not found')},_url_from_array:function(t,e,n){var o,r=e.match(this.token_regex),i=e.split(this.token_regex),s=i[0]
if(r||0!==n.length){if(r&&r.length!=n.length)throw new _('Wrong number of argument for pattern "'+t+'"')
for(o=0;o<n.length;o++)s+=n[o]+i[o+1]}return s},_url_from_object:function(t,e,n){var o,r,i,s,u=e,c=e.match(this.token_regex)
if(c)for(o=0;o<c.length;o++){if(void 0===(s=n[i=(r=c[o]).slice(1,-1)]))throw new _('Property "'+i+'" not found')
...
break}return r},csrf_token:function(){return this._getCookie(window.DJANGO_JS_CSRF_COOKIE_NAME||"csrftoken")},csrf_element:function(){var t=this.csrf_token()
return['<input type="hidden" name="csrfmiddlewaretoken" value="',t||"",'">'].join("")},jquery_csrf:function(){var i=this._getCookie
s(document).ajaxSend(function(t,e,n){var o,r;/^(GET|HEAD|OPTIONS|TRACE)$/.test(n.type)||(n=n.url,o="//"+document.location.host,r=document.location.protocol+o,n!=r&&n.slice(0,r.length+1)!=r+"/"&&n!=o&&n.slice(0,o.length+1)!=o+"/"&&/^(\/\/|http:|https:).*/.test(n))||e.setRequestHeader("X-CSRFToken",i(window.DJANGO_JS_CSRF_COOKIE_NAME||"csrftoken"))})},absolute:function(t,e){if(this.context.hasOwnProperty("ABSOLUTE_ROOT"))return this.context.ABSOLUTE_ROOT+this.url(t,e)
throw new _("django-absolute needed to call absolute()")},site:function(t,e){if(this.context.hasOwnProperty("SITE_ROOT"))return this.context.SITE_ROOT+this.url(t,e)
throw new _("django-absolute needed to call site()")}}
